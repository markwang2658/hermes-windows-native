...
[![Windows Native](./hermes-guide/images/icon/windows-native.svg)](./hermes-guide/README.zh-CN.md)
[![Python 3.11+](./hermes-guide/images/icon/python-311.svg)](./hermes-guide/README.zh-CN.md)
[![PowerShell](./hermes-guide/images/icon/powershell.svg)](./hermes-guide/README.zh-CN.md)
[![Guide](./hermes-guide/images/icon/guide.svg)](./hermes-guide/README.zh-CN.md)
...
- 更详细的安装和快速开始文档已收进仓库内的 `hermes-guide\`
...
更完整的安装和使用文档已经放进当前仓库的 `hermes-guide\` 目录：

文档入口：

- 英文首页：[README](./hermes-guide/README.md)
- 中文首页：[README.zh-CN.md](./hermes-guide/README.zh-CN.md)
- 英文安装文档：[EN/installation.md](./hermes-guide/EN/installation.md)
- 英文快速开始：[EN/quick-start.md](./hermes-guide/EN/quick-start.md)
- 中文安装文档：[zh-CN/installation.md](./hermes-guide/zh-CN/installation.md)
- 中文快速开始：[zh-CN/quick-start.md](./hermes-guide/zh-CN/quick-start.md)
